...
const uint8_t LIT_ADDRESS[ADDRESS_LENGTH] = { 0x02, 0x05, 0x06, 0x65, 0x21, 0x55, 0x0d, 
                                              0x7d, 0x7a, 0xb1, 0x9d, 0xa8, 0xf7, 0x2b, 
                                              0xb0, 0x04, 0xb4, 0xc3, 0x41 };


const uint8_t LINK_ADDRESS[ADDRESS_LENGTH] = { 0x49, 0x10, 0x77, 0x1a, 0xf9, 0xca, 0x65,
                                               0x6a, 0xf8, 0x40, 0xdf, 0xf8, 0x3e, 0x82, 
                                               0x64, 0xec, 0xf9, 0x86, 0xca };

const uint8_t SUSHI_ADDRESS[ADDRESS_LENGTH] = { 0x35, 0x95, 0x06, 0x87, 0x78, 0xdd, 0x59, 
                                                0x2e, 0x39, 0xa1, 0x22, 0xf4, 0xf5, 0xa5,
                                                0xcf, 0x09, 0xc9, 0x0f, 0xe2 };

const uint8_t SYNTHETIC_ADDRESS[ADDRESS_LENGTH] = { 0xab, 0x1e, 0xc2, 0x8d, 0x12, 0x97, 0x07,
                                                    0x05, 0x2d, 0xf4, 0xdf, 0x41, 0x8d, 0x58, 
                                                    0xa2, 0xd4, 0x6d, 0x5f, 0x51 };

const uint8_t UNI_ADDRESS[ADDRESS_LENGTH] = { 0x98, 0x40, 0xa8, 0x5d, 0x5a, 0xf5, 0xbf, 
                                              0x1d, 0x17, 0x62, 0xf9, 0x25, 0xbd, 0xad, 
                                              0xdc, 0x42, 0x01, 0xf9, 0x84 };

const uint8_t TUSD_ADDRESS[ADDRESS_LENGTH] = { 0x00, 0x00, 0x00, 0x00, 0x08, 0x5d, 0x47,
                                               0x80, 0xb7, 0x31, 0x19, 0xb6, 0x44, 0xae, 
                                               0x5e, 0xcd, 0x22, 0xb3, 0x76 };

const uint8_t USDP_ADDRESS[ADDRESS_LENGTH] = { 0x87, 0x0d, 0x67, 0xf6, 0x60, 0xd9, 0x5d,
                                               0x5b, 0xe5, 0x30, 0x38, 0x0d, 0x0e, 0xc0, 
                                               0xbd, 0x38, 0x82, 0x89, 0xe1 };

const uint8_t WBTC_ADDRESS[ADDRESS_LENGTH] = { 0x87, 0x0d, 0x67, 0xf6, 0x60, 0xd9, 0x5d,
                                               0x5b, 0xe5, 0x30, 0x38, 0x0d, 0x0e, 0xc0, 
                                               0xbd, 0x38, 0x82, 0x89, 0xe1 };
