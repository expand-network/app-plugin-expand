...
# echo "**Building app-swell for Nano S..."
# make clean
# make -j DEBUG=1
...
# echo "**Building app-swell for Nano X..."
# make clean
# make -j DEBUG=1
...
echo "done"plugin_dev/ folder, runsudo docker run --rm -ti -v "$(realpath .):/app" --user $(id -u $USER):$(id -g $USER) ghcr.io/ledgerhq/ledger-app-builder/ledger-app-dev-tools:latest